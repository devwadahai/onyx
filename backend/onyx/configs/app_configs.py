...
# Master switch: when False the reclaim beat task no-ops entirely. Defaults on;
# set OLD_INDEX_RECLAIM_ENABLED=false as an instant kill switch if anything goes wrong.
